...
| 文档名称 | 说明 |
|---------|------|
| [完整配置总结](./COMPLETE_CONFIGURATION_SUMMARY.md) | **★推荐** 系统配置完整指南,包含所有环境变量说明 |
| [配置指南](./CONFIGURATION_GUIDE.md) | 详细配置说明和优化建议 |
| [.env.example](../.env.example) | 配置文件模板 |
| [pytest.ini](./pytest.ini) | pytest测试配置 |

### 修复和问题文档

| 文档名称 | 说明 |
|---------|------|
| [qa_system索引配置](./QA_SYSTEM_INDEX_CONFIG.md) | **★最新** qa_system索引配置完整说明 |
| [紧急修复总结](./URGENT_FIX_SUMMARY.md) | LLM流式模式错误和配置化系统实现 |
| [索引名称修正](./INDEX_NAME_FIX.md) | qa_system索引发现和修正过程 |
| [流式输出修复](./STREAMING_OUTPUT_FIX.md) | 流式输出格式和标签说明 |
